...
Next, we assume, in the contrary, that $C > 458$.
Notice that $T=\sum_{e\in[n]} T(e)$. 
...
\begin{align}
	T &\le n+\sum_{e\in [n]}\frac{18 \rank(\M)^2 R^2}{\Delta_e^2} \log(4nT^3/\delta) \nonumber\\
		...
		&\le n+18 \mathbf{\tilde H}\log(4n/\delta)+ 54\mathbf{\tilde H}\log\left(2C\right)
...
Eq.~\eqref{eq:cmr-t-4} follows from the fact that $\mathbf{\tilde H} \ge 1$;
