...
hence, arms cannot be simply eliminated purely based on their own rewards in the learning algorithm
...
Furthermore, as we will see later in our examples, for many decision classes, there are exchange classes embodying natural combinatorial structures, e.g. augmenting paths and cycles of matchings.
...
\begin{align*}
  \E_0[T_b] &= \E_0[T_{b_-}]+\E_0[T_{b_+}] \\
  		    ...
  		    &\ge \frac{(|b_+|+|b_-|)^2}{32 w(b)^2}\log(1/4\delta).
\end{align*}
\end{proof}
