...
Therefore, the sample complexity bound of \Algorithm is $O\big(\mathbf H \log(n\mathbf H/\delta)\big)$ for the \MultiIdent problem .
...
We conjecture that the dependency on $\rank(\M)$ of the sample complexity might be intrinsic. 
