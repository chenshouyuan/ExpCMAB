...
%The collection of subsets of arms which satisfy certain combinatorial constraint is referred as a \emph{decision class}.
%We call such a collection of subsets of arms a {\em decision class}.	
...
In addition, applying our results back to the problems of top-$K$ arms identification and multiple bandit best arms identification, we recover the best available upper bounds and settle two open conjectures on the lower bounds.
