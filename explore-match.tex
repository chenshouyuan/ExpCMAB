...
We also notice that our result resolves the conjecture of \citet{bubeck2013multiple} on the problem-dependent sample complexity lower bounds of \MultiIdent and \MultiBandit problems, for the case
	of Gaussian reward distributions.
...
\end{align*}
Now we have proven that, if $\E_0[T_e] < t_e^*$, then $\Pr_1[\mathcal B]>\delta$.
